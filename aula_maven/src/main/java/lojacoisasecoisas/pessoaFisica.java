...
public class pessoaFisica extends pessoa {
	 ...
	 public pessoaFisica(String registro, String nome, String email) {
	...
	public void salvar(){//salva cliente na tabela cliente;
		...
		try {
			...
			String sql = "insert into clientes(registro, nome, email)values(?,?,?)";
	        ...
	        //System.out.println();
			String msg = "Duplicate entry '"+this.registro+"' for key 'clientes.PRIMARY'";
	...
	public void delete() {//metodo para deletar cliente da tabela clientes;
		...
		try {
			...
			String sql = "delete from clientes where registro = ?";
	...
	private void update(String registro, String nome, String email) {
		...
		try {
			...
			String sql = "UPDATE clientes SET nome = ?, email = ? WHERE (registro= ?)";
	...
	public void find_one(){//metodo para imprimir um cliente especifico;
